...
x(1) = 2.69	!clay cond. artificial values
...
N_fr = 10
step = 1./N_fr
open(1,file = 'LP_GSA_CONC_AR0_0001.txt')
...
write(1,'(1x,10(1x,f12.6))')x(4), P(1,1),P(2,2), P(3,3)
write(*,'(1x,10(1x,f12.6))')x(4), P(1,1),P(2,2), P(3,3)

!write(1,'(1x,10(1x,f12.6))')pore_porosity, P(1,1),P(2,2), P(3,3)
!write(*,'(1x,10(1x,f12.6))')pore_porosity, P(1,1),P(2,2), P(3,3)
end do
...
call parts_CONC(lambda0,lambda_i,F_i,sumc_i,sumz_i)
!write(*,*)'i = ',i
!write(*,*)'sumc_i'
!write(*,*)sumc_i
...
!-------------------------------------
subroutine parts_CONC(lambda0,lambda_i,F_i,sumc_i,sumz_i)
...
real(8) AI(3,3),S1(3,3),S2(3,3),S3(3,3),lambda0_inv(3,3),F_form(3,3),CONC(3,3),CONC_inv(3,3)
!---------------------
!write(*,*)'lambda0 = '
...
F_form(3,3) = F_i
F_form(1,1) = (1. - F_i)/2.
F_form(2,2) = F_form(1,1)


call F1111(lambda0, lambda0_inv, ind_err)
call matrix_product_3(lambda0_inv,F_form,S1)
call matrix_product_3(S1,lambda_i,S2)
call matrix_product_3(S1,lambda0,S3)
