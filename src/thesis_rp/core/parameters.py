...
from thesis_rp.models.matrix.mineral_mixing import compute_matrix_properties_from_minerals
from thesis_rp.utils.validation import ensure_fraction, ensure_positive
...
class FluidPhase:
    ...
    @staticmethod
    def air() -> "FluidPhase":
        from thesis_rp.models.fluids.fluid_properties import AIR
        return AIR

    @staticmethod
    def brine() -> "FluidPhase":
        from thesis_rp.models.fluids.fluid_properties import BRINE
        return BRINE

    @staticmethod
    def oil() -> "FluidPhase":
        from thesis_rp.models.fluids.fluid_properties import OIL
        return OIL
